    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('embed_model', models.CharField(choices=[('OPENAI_TEXT_EMBEDDING_3_LARGE', 'openai text-embedding-3-large'), ('OPENAI_TEXT_EMBEDDING_3_SMALL', 'openai text-embedding-3-small')])),
            ],
            options={
                'db_table': 'neurons',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('log_id', models.AutoField(primary_key=True, serialize=False)),
                ('memory_id', models.IntegerField()),
                ('state', models.CharField(choices=[('NOT_STARTED', 'not started'), ('PROCESSING', 'processing'), ('INDEXED', 'indexed')], default='NOT_STARTED')),
